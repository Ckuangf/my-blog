/** cifor-v2.4.5 MIT License By https://www.cifor.com */
;!function (e) {
    "use strict";
    var t = document, o = {modules: {}, status: {}, timeout: 10, event: {}}, n = function () {
        ...
        e.console && console.error && console.error("Cifor hint: " + t)
    ...
    n.prototype.cache = o, n.prototype.define = function (e, t) {
        ...
        return r && (t = e, e = []), cifor["cifor.all"] || !cifor["cifor.all"] && cifor["cifor.mobile"] ? i.call(n) : (n.use(e, i), n)
        ...
        function c() {
            l.push(cifor[f]), e.length > 1 ? y.use(e.slice(1), n, l) : "function" == typeof n && n.apply(cifor, l)
        }

        var y = this, p = o.dir = o.dir ? o.dir : r, d = t.getElementsByTagName("head")[0];
        e = "string" == typeof e ? [e] : e, window.jQuery && jQuery.fn.on && (y.each(e, function (t, o) {
            "jquery" === o && e.splice(t, 1)
        }), cifor.jquery = cifor.$ = jQuery);
        var f = e[0], m = 0;
        if (l = l || [], o.host = o.host || (p.match(/\/\/([\s\S]+?)\//) || ["//" + location.host + "/"])[0], 0 === e.length || cifor["cifor.all"] && u[f] || !cifor["cifor.all"] && cifor["cifor.mobile"] && u[f]) return c(), y;
        ...
        "string" == typeof n && (r = n);
        var s = (r || e).replace(/\.|\//g, ""), c = u.id = "ciforcss-" + s, y = 0;
        ...
        if (cifor[e]) return "function" == typeof o.callback[e] ? o.callback[e] : null
    }, n.prototype.addcss = function (e, t, n) {
        return cifor.link(o.dir + "css/" + e, t, n)
        ...
        if (t = t || "cifor", n = n || localStorage, e.JSON && e.JSON.parse) {
        ...
        return r ? (o.event[l] = o.event[l] || {}, o.event[l][s] = [r], this) : (cifor.each(o.event[l], function (e, t) {
            return "{*}" === s ? void cifor.each(t, c) : ("" === e && cifor.each(t, c), void (s && e === s && cifor.each(t, c)))
        }), a)
    }, e.cifor = new n
}(window);
cifor.define(function (a) {
    var i = cifor.cache;
    cifor.config({dir: i.dir.replace(/lay\/dest\/$/, "")}), a("cifor.all", cifor.v)
});
cifor.define(function (e) {
    "use strict";
    var r = {open: "{{", close: "}}"}, c = {
        exp: function (e) {
...
cifor.define(function (e) {
    "use strict";
    var a = document, t = "getElementById", n = "getElementsByTagName", i = "laypage", r = "cifor-disabled",
        u = function (e) {
            var a = this;
    ...
    u.prototype.type = function () {
        ...
        var n = a.pages > t ? Math.ceil((a.curr + (t > 1 ? 1 : 0)) / (t > 0 ? t : 1)) : 1, i = {
            prev: function () {
                return a.prev ? '<a href="javascript:;" class="cifor-laypage-prev' + (1 == a.curr ? " " + r : "") + '" data-page="' + (a.curr - 1) + '">' + a.prev + "</a>" : ""
            }(),
            page: function () {
                var e = [];
                if (a.count < 1) return "";
                n > 1 && a.first !== !1 && 0 !== t && e.push('<a href="javascript:;" class="cifor-laypage-first" data-page="1"  title="&#x9996;&#x9875;">' + (a.first || 1) + "</a>");
                var i = Math.floor((t - 1) / 2), r = n > 1 ? a.curr - i : 1, u = n > 1 ? function () {
                    var e = a.curr + (t - i - 1);
                    return e > a.pages ? a.pages : e
                }() : t;
                for (u - r < t - 1 && (r = u - t + 1), a.first !== !1 && r > 2 && e.push('<span class="cifor-laypage-spr">&#x2026;</span>'); r <= u; r++) r === a.curr ? e.push('<span class="cifor-laypage-curr"><em class="cifor-laypage-em" ' + (/^#/.test(a.theme) ? 'style="background-color:' + a.theme + ';"' : "") + "></em><em>" + r + "</em></span>") : e.push('<a href="javascript:;" data-page="' + r + '">' + r + "</a>");
                return a.pages > t && a.pages > u && a.last !== !1 && (u + 1 < a.pages && e.push('<span class="cifor-laypage-spr">&#x2026;</span>'), 0 !== t && e.push('<a href="javascript:;" class="cifor-laypage-last" title="&#x5C3E;&#x9875;"  data-page="' + a.pages + '">' + (a.last || a.pages) + "</a>")), e.join("")
            }(),
            next: function () {
                return a.next ? '<a href="javascript:;" class="cifor-laypage-next' + (a.curr == a.pages ? " " + r : "") + '" data-page="' + (a.curr + 1) + '">' + a.next + "</a>" : ""
            }(),
            count: '<span class="cifor-laypage-count">共 ' + a.count + " 条</span>",
            limit: function () {
                var e = ['<span class="cifor-laypage-limits"><select lay-ignore>'];
                return cifor.each(a.limits, function (t, n) {
                    e.push('<option value="' + n + '"' + (n === a.limit ? "selected" : "") + ">" + n + " 条/页</option>")
                }), e.join("") + "</select></span>"
            }(),
            refresh: ['<a href="javascript:;" data-page="' + a.curr + '" class="cifor-laypage-refresh">', '<i class="cifor-icon cifor-icon-refresh"></i>', "</a>"].join(""),
            skip: function () {
                return ['<span class="cifor-laypage-skip">&#x5230;&#x7B2C;', '<input type="text" min="1" value="' + a.curr + '" class="cifor-input">', '&#x9875;<button type="button" class="cifor-laypage-btn">&#x786e;&#x5b9a;</button>', "</span>"].join("")
            }()
        };
        return ['<div class="cifor-box cifor-laypage cifor-laypage-' + (a.theme ? /^#/.test(a.theme) ? "molv" : a.theme : "default") + '" id="cifor-laypage-' + a.index + '">', function () {
            var e = [];
            return cifor.each(a.layout, function (a, t) {
                i[t] && e.push(i[t])
            }), e.join("")
        }(), "</div>"].join("")
        ...
        var s = a[t]("cifor-laypage-" + i.index);
    ...
    var s = {
        render: function (e) {
            var a = new u(e);
            return a.index
        }, index: cifor.laypage ? cifor.laypage.index + 1e4 : 0, on: function (e, a, t) {
...
!function () {
    "use strict";
    var e = window.cifor && cifor.define, t = {
            getPath: function () {
                ...
                if (n.path) {
                    ...
                    "string" == typeof a && (i = a);
                    var s = (i || e).replace(/\.|\//g, ""), l = "ciforcss-" + s, d = 0;
            ...
            ready: function (a) {
                ...
                return e ? cifor.addcss(o, a, i) : t.link(o, a, i), this
            }
        }, a = function () {
            var e = this;
            return {
        ...
        }, i = "laydate", r = ".cifor-laydate", o = "cifor-this", s = "laydate-disabled", l = "开始日期超出了结束日期<br>建议重新选择",
        d = [100, 2e5], c = "cifor-laydate-static", m = "cifor-laydate-list", u = "laydate-selected",
        h = "cifor-laydate-hint", y = "laydate-day-prev", f = "laydate-day-next", p = "cifor-laydate-footer",
    ...
    C.prototype = [], C.prototype.constructor = C, w.extend = function () {
        ...
        }), e.elemID = "cifor-laydate" + t.elem.attr("lay-key"), (t.show || a) && e.render(), a || e.events(), t.value && t.isInitValue && (t.value.constructor === Date ? e.setValue(e.parse(0, e.systemDate(t.value))) : e.setValue(t.value)))
    }, T.prototype.render = function () {
        var e = this, t = e.config, n = e.lang(), a = "static" === t.position, i = e.elem = w.elem("div", {
                id: e.elemID,
                "class": ["cifor-laydate", t.range ? " cifor-laydate-range" : "", a ? " " + c : "", t.theme && "default" !== t.theme && !/^#/.test(t.theme) ? " laydate-theme-" + t.theme : ""].join("")
            }), r = e.elemMain = [], o = e.elemHeader = [], s = e.elemCont = [], l = e.table = [],
            d = e.footer = w.elem("div", {"class": p});
        if (t.zIndex && (i.style.zIndex = t.zIndex), w.each(new Array(2), function (e) {
            if (!t.range && e > 0) return !0;
            var a = w.elem("div", {"class": "cifor-laydate-header"}), i = [function () {
                    var e = w.elem("i", {"class": "cifor-icon laydate-icon laydate-prev-y"});
                    return e.innerHTML = "&#xe65a;", e
                }(), function () {
                    var e = w.elem("i", {"class": "cifor-icon laydate-icon laydate-prev-m"});
                    return e.innerHTML = "&#xe603;", e
                }(), function () {
                    var e = w.elem("div", {"class": "laydate-set-ym"}), t = w.elem("span"), n = w.elem("span");
                    return e.appendChild(t), e.appendChild(n), e
                }(), function () {
                    var e = w.elem("i", {"class": "cifor-icon laydate-icon laydate-next-m"});
                    return e.innerHTML = "&#xe602;", e
                }(), function () {
                    var e = w.elem("i", {"class": "cifor-icon laydate-icon laydate-next-y"});
                    return e.innerHTML = "&#xe65b;", e
                }()], d = w.elem("div", {"class": "cifor-laydate-content"}), c = w.elem("table"), m = w.elem("thead"),
                u = w.elem("tr");
            ...
            }), c.insertBefore(m, c.children[0]), d.appendChild(c), r[e] = w.elem("div", {"class": "cifor-laydate-main laydate-main-list-" + e}), r[e].appendChild(a), r[e].appendChild(d), o.push(i), s.push(d), l.push(c)
        }), w(d).html(function () {
            var e = [], i = [];
            ...
            var m = w.elem("style"),
                u = ["#{{id}} .cifor-laydate-header{background-color:{{theme}};}", "#{{id}} .cifor-this{background-color:{{theme}} !important;}"].join("").replace(/{{id}}/g, e.elemID).replace(/{{theme}}/g, t.theme);
    ...
    }, window.lay = window.lay || w, e ? (n.ready(), cifor.define(function (e) {
        n.path = cifor.cache.dir, e(i, n)
...
!function (e, t) {
    ...
    return pe.fn.load = function (e, t, n) {
        ...
        return this.length
    }, pe.fn.andSelf = pe.fn.addBack, cifor.define(function (e) {
        cifor.$ = pe, e("jquery", pe)
    }), pe
});
!function (e, t) {
    "use strict";
    var i, n, a = e.cifor && cifor.define, o = {
        getPath: function () {
            var e = document.currentScript ? document.currentScript.src : function () {
        ...
        link: function (t, i, n) {
            if (r.path) {
                ...
                "string" == typeof i && (n = i);
                var l = (n || t).replace(/\.|\//g, ""), f = "ciforcss-" + l, c = 0;
        ...
        v: "3.1.1", ie: function () {
            ...
            return e = e || {}, r.cache = o.config = i.extend({}, o.config, e), r.path = o.config.path || r.path, "string" == typeof e.extend && (e.extend = [e.extend]), o.config.path && r.ready(), e.extend ? (a ? cifor.addcss("modules/layer/" + e.extend) : o.link("theme/" + e.extend), this) : this
        }, ready: function (e) {
            var t = "layer", i = "", n = (a ? "modules/layer/" : "theme/") + "default/layer.css?v=" + r.v + i;
            return a ? cifor.addcss(n, e, t) : o.link(n, e, t), this
            ...
            var s = "function" == typeof n, f = o.config.skin, c = (f ? f + " " + f + "-msg" : "") || "cifor-layer-msg",
                u = l.anim.length - 1;
            ...
            }, s && !o.config.skin ? {skin: c + " cifor-layer-hui", anim: u} : function () {
                return n = n || {}, (n.icon === -1 || n.icon === t && !o.config.skin) && (n.skin = c + " " + (n.skin || "cifor-layer-hui")), n
            }()))
        }, load: function (e, t) {
    ...
    s.pt = s.prototype;
    var l = ["cifor-layer", ".cifor-layer-title", ".cifor-layer-main", ".cifor-layer-dialog", "cifor-layer-iframe", "cifor-layer-content", "cifor-layer-btn", "cifor-layer-close"];
    l.anim = ["layer-anim-00", "layer-anim-01", "layer-anim-02", "layer-anim-03", "layer-anim-04", "layer-anim-05", "layer-anim-06"], s.pt.config = {
        ...
        var n = this, a = n.index, r = n.config, s = r.zIndex + a, f = "object" == typeof r.title,
            ...
            u = r.title ? '<div class="cifor-layer-title" style="' + (f ? r.title[1] : "") + '">' + (f ? r.title[0] : r.title) + "</div>" : "";
        return r.zIndex = s, t([r.shade ? '<div class="cifor-layer-shade" id="cifor-layer-shade' + a + '" times="' + a + '" style="' + ("z-index:" + (s - 1) + "; ") + '"></div>' : "", '<div class="' + l[0] + (" cifor-layer-" + o.type[r.type]) + (0 != r.type && 2 != r.type || r.shade ? "" : " cifor-layer-border") + " " + (r.skin || "") + '" id="' + l[0] + a + '" type="' + o.type[r.type] + '" times="' + a + '" showtime="' + r.time + '" conType="' + (e ? "object" : "string") + '" style="z-index: ' + s + "; width:" + r.area[0] + ";height:" + r.area[1] + (r.fixed ? "" : ";position:absolute;") + '">' + (e && 2 != r.type ? "" : u) + '<div id="' + (r.id || "") + '" class="cifor-layer-content' + (0 == r.type && r.icon !== -1 ? " cifor-layer-padding" : "") + (3 == r.type ? " cifor-layer-loading" + r.icon : "") + '">' + (0 == r.type && r.icon !== -1 ? '<i class="cifor-layer-ico cifor-layer-ico' + r.icon + '"></i>' : "") + (1 == r.type && e ? "" : r.content || "") + '</div><span class="cifor-layer-setwin">' + function () {
            var e = c ? '<a class="cifor-layer-min" href="javascript:;"><cite></cite></a><a class="cifor-layer-ico cifor-layer-max" href="javascript:;"></a>' : "";
            return r.closeBtn && (e += '<a class="cifor-layer-ico ' + l[7] + " " + l[7] + (r.title ? r.closeBtn : 4 == r.type ? "1" : "2") + '" href="javascript:;"></a>'), e
        }() + "</span>" + (r.btn ? function () {
            var e = "";
            "string" == typeof r.btn && (r.btn = [r.btn]);
            for (var t = 0, i = r.btn.length; t < i; t++) e += '<a class="' + l[6] + t + '">' + r.btn[t] + "</a>";
            return '<div class="' + l[6] + " cifor-layer-btn-" + (r.btnAlign || "") + '">' + e + "</div>"
        }() : "") + (r.resize ? '<span class="cifor-layer-resize"></span>' : "") + "</div>"], u, i('<div class="cifor-layer-move"></div>')), n
    }, s.pt.creat = function () {
        ...
        if (!t.id || !i("#" + t.id)[0]) {
            switch ("string" == typeof t.area && (t.area = "auto" === t.area ? ["", ""] : [t.area, ""]), t.shift && (t.anim = t.shift), 6 == r.ie && (t.fixed = !1), t.type) {
                ...
                case 2:
                    ...
                    t.content = '<iframe scrolling="' + (t.content[1] || "auto") + '" allowtransparency="true" id="' + l[4] + a + '" name="' + l[4] + a + '" onload="this.className=\'\';" class="cifor-layer-load" frameborder="0" src="' + t.content[0] + '"></iframe>';
                    break;
                case 3:
                    delete t.title, delete t.closeBtn, t.icon === -1 && 0 === t.icon, r.closeAll("loading");
                    break;
                case 4:
                    f || (t.content = [t.content, "body"]), t.follow = t.content[1], t.content = t.content[0] + '<i class="cifor-layer-TipsG"></i>', delete t.title, t.tips = "object" == typeof t.tips ? t.tips : [t.tips, !0], t.tipsMore || r.closeAll("tips")
            }
            if (e.vessel(f, function (n, r, u) {
                c.append(n[0]), f ? function () {
                    2 == t.type || 4 == t.type ? function () {
                        ...
                        s.parents("." + l[0])[0] || (s.data("display", s.css("display")).show().addClass("cifor-layer-wrap").wrap(n[1]), i("#" + l[0] + a).find("." + l[5]).before(r))
                    }()
                }() : c.append(n[1]), i(".cifor-layer-move")[0] || c.append(o.moveElem = u), e.layero = i("#" + l[0] + a), t.scrollbar || l.html.css("overflow", "hidden").attr("layer-full", a)
            }).auto(a), i("#cifor-layer-shade" + e.index).css({
        ...
        var s = {width: r.outerWidth(), height: r.outerHeight(), top: r.offset().top, left: r.offset().left},
            f = a.find(".cifor-layer-TipsG"), c = t.tips[0];
        t.tips[1] || f.remove(), s.autoLeft = function () {
            ...
            s.autoLeft(), s.tipTop = s.top - o[1] - 10, f.removeClass("cifor-layer-TipsB").addClass("cifor-layer-TipsT").css("border-right-color", t.tips[1])
        }, function () {
            s.tipLeft = s.left + s.width + 10, s.tipTop = s.top, f.removeClass("cifor-layer-TipsL").addClass("cifor-layer-TipsR").css("border-bottom-color", t.tips[1])
        }, function () {
            s.autoLeft(), s.tipTop = s.top + s.height + 10, f.removeClass("cifor-layer-TipsT").addClass("cifor-layer-TipsB").css("border-right-color", t.tips[1])
        }, function () {
            s.tipLeft = s.left - o[0] - 10, s.tipTop = s.top, f.removeClass("cifor-layer-TipsR").addClass("cifor-layer-TipsL").css("border-bottom-color", t.tips[1])
        ...
        }), n.find("." + l[7]).on("click", e), a.shadeClose && i("#cifor-layer-shade" + t.index).on("click", function () {
            r.close(t.index)
        }), n.find(".cifor-layer-min").on("click", function () {
            var e = a.min && a.min(n);
            e === !1 || r.min(t.index, a)
        }), n.find(".cifor-layer-max").on("click", function () {
            i(this).hasClass("cifor-layer-maxmin") ? (r.restore(t.index), a.restore && a.restore(n)) : (r.full(t.index, a), setTimeout(function () {
                a.full && a.full(n)
            }, 100))
        ...
        e.find(".cifor-layer-max").addClass("cifor-layer-maxmin"), e.attr({area: t})
        ...
        var a = i("#" + l[0] + e), r = a.find(".cifor-layer-content"), s = a.attr("type"),
        ...
        o.record(a), o.minLeft[0] && (f = o.minLeft[0], o.minLeft.shift()), a.attr("position", c), r.style(e, {
            ...
            position: "fixed",
            overflow: "hidden"
        }, !0), a.find(".cifor-layer-min").hide(), "page" === a.attr("type") && a.find(l[4]).hide(), o.rescollbar(e), a.attr("minLeft") || o.minIndex++, a.attr("minLeft", f)
        ...
        r.style(e, {
            ...
            overflow: "visible"
        }, !0), t.find(".cifor-layer-max").removeClass("cifor-layer-maxmin"), t.find(".cifor-layer-min").show(), "page" === t.attr("type") && t.find(l[4]).show(), o.rescollbar(e)
    }, r.full = function (e) {
        var t, a = i("#" + l[0] + e);
        ...
        if (t[0]) {
            var s = "cifor-layer-wrap", f = function () {
            ...
            t.data("isOutAnim") && t.addClass("layer-anim " + a), i("#cifor-layer-moves, #cifor-layer-shade" + e).remove(), 6 == r.ie && o.reselect(), o.rescollbar(e), t.attr("minLeft") && (o.minIndex--, o.minLeft.push(t.attr("minLeft"))), r.ie && r.ie < 10 || !t.data("isOutAnim") ? f() : setTimeout(function () {
                f()
            }, 200)
        }
    ...
    r.prompt = function (e, t) {
        ...
        var s, l = 2 == e.formType ? '<textarea class="cifor-layer-input"' + a + "></textarea>" : function () {
            return '<input type="' + (1 == e.formType ? "password" : "text") + '" class="cifor-layer-input">'
        }(), f = e.success;
        return delete e.success, r.open(i.extend({
            type: 1,
            btn: ["&#x786E;&#x5B9A;", "&#x53D6;&#x6D88;"],
            content: l,
            skin: "cifor-layer-prompt" + c("prompt"),
            maxWidth: n.width(),
            success: function (t) {
                s = t.find(".cifor-layer-input"), s.val(e.value || "").focus(), "function" == typeof f && f(t)
            },
            resize: !1,
            yes: function (i) {
                var n = s.val();
        ...
        e = e || {};
        var t = e.tab || {}, n = "cifor-this", a = e.success;
        return delete e.success, r.open(i.extend({
            type: 1,
            skin: "cifor-layer-tab" + c("tab"),
            resize: !1,
            title: function () {
            ...
            content: '<ul class="cifor-layer-tabmain">' + function () {
                var e = t.length, i = 1, a = "";
                if (e > 0) for (a = '<li class="cifor-layer-tabli ' + n + '">' + (t[0].content || "no content") + "</li>"; i < e; i++) a += '<li class="cifor-layer-tabli">' + (t[i].content || "no  content") + "</li>";
                return a
            }() + "</ul>",
            success: function (t) {
                var o = t.find(".cifor-layer-title").children(), r = t.find(".cifor-layer-tabmain").children();
        ...
        if (t = t || {}, t.photos) {
            ...
            s.imgprev = function (e) {
                ...
                s.bigimg.hover(function () {
                    ...
                    s.imgsee.hide()
                }), s.bigimg.find(".cifor-layer-imgprev").on("click", function (e) {
                    e.preventDefault(), s.imgprev()
                }), s.bigimg.find(".cifor-layer-imgnext").on("click", function (e) {
                    e.preventDefault(), s.imgnext()
                }), i(document).on("keyup", s.keyup)
            }, s.loadi = r.load(1, {shade: !("shade" in t) && .9, scrollbar: !1}), o(u[d].src, function (n) {
                r.close(s.loadi), s.index = r.open(i.extend({
                    type: 1,
                    id: "cifor-layer-photos",
                    area: function () {
                    ...
                    shadeClose: !0,
                    closeBtn: !1,
                    move: ".cifor-layer-phimg img",
                    moveType: 1,
                    scrollbar: !1,
                    moveOut: !0,
                    isOutAnim: !1,
                    skin: "cifor-layer-photos" + c("photos"),
                    content: '<div class="cifor-layer-phimg"><img src="' + u[d].src + '" alt="' + (u[d].alt || "") + '" layer-pid="' + u[d].pid + '"><div class="cifor-layer-imgsee">' + (u.length > 1 ? '<span class="cifor-layer-imguide"><a href="javascript:;" class="cifor-layer-iconext cifor-layer-imgprev"></a><a href="javascript:;" class="cifor-layer-iconext cifor-layer-imgnext"></a></span>' : "") + '<div class="cifor-layer-imgbar" style="display:' + (a ? "block" : "") + '"><span class="cifor-layer-imgtit"><a href="javascript:;">' + (u[d].alt || "") + "</a><em>" + s.imgIndex + "/" + u.length + "</em></span></div></div></div>",
                    success: function (e, i) {
                        s.bigimg = e.find(".cifor-layer-phimg"), s.imgsee = e.find(".cifor-layer-imguide,.cifor-layer-imgbar"), s.event(e), t.tab && t.tab(u[d], e), "function" == typeof y && y(e)
                    },
                    end: function () {
    ...
    }, e.cifor && cifor.define ? (r.ready(), cifor.define("jquery", function (t) {
        r.path = cifor.cache.dir, o.run(cifor.$), e.layer = r, t("layer", r)
...
cifor.define("jquery", function (t) {
    "use strict";
    var a = cifor.$, i = (cifor.hint(), cifor.device()), e = "element", l = "cifor-this", n = "cifor-show",
        s = function () {
            this.config = {}
        };
    s.prototype.set = function (t) {
        ...
        return cifor.onevent.call(this, e, t, a)
    }, s.prototype.tabAdd = function (t, i) {
        var e = ".cifor-tab-title", l = a(".cifor-tab[lay-filter=" + t + "]"), n = l.children(e),
            s = n.children(".cifor-tab-bar"), o = l.children(".cifor-tab-content"),
            r = '<li lay-id="' + (i.id || "") + '"' + (i.attr ? ' lay-attr="' + i.attr + '"' : "") + ">" + (i.title || "unnaming") + "</li>";
        return s[0] ? s.before(r) : n.append(r), o.append('<div class="cifor-tab-item">' + (i.content || "") + "</div>"), f.hideTabMore(!0), f.tabAuto(), this
        ...
        var e = "cifor-progress", l = a("." + e + "[lay-filter=" + t + "]"), n = l.find("." + e + "-bar"),
            s = n.find("." + e + "-text");
        return n.css("width", i), s.text(i), this
    };
    var o = ".cifor-nav", r = "cifor-nav-item", c = "cifor-nav-bar", u = "cifor-nav-tree", d = "cifor-nav-child",
        y = "cifor-nav-more", h = "cifor-anim cifor-anim-upbit", f = {
            tabClick: function (t, i, s, o) {
                o = o || {};
                var r = s || a(this), i = i || r.parent().children("li").index(r),
                    c = o.headerElem ? r.parent() : r.parents(".cifor-tab").eq(0),
                    u = o.bodyElem ? a(o.bodyElem) : c.children(".cifor-tab-content").children(".cifor-tab-item"),
                    d = r.find("a"), y = c.attr("lay-filter");
                "javascript:;" !== d.attr("href") && "_blank" === d.attr("target") || (r.addClass(l).siblings().removeClass(l), u.eq(i).addClass(n).siblings().removeClass(n)), cifor.event.call(this, e, "tab(" + y + ")", {
                    elem: c,
                    index: i
                })
            }, tabDelete: function (t, i) {
                var n = i || a(this).parent(), s = n.index(), o = n.parents(".cifor-tab").eq(0),
                    r = o.children(".cifor-tab-content").children(".cifor-tab-item"), c = o.attr("lay-filter");
                n.hasClass(l) && (n.next()[0] ? f.tabClick.call(n.next()[0], null, s + 1) : n.prev()[0] && f.tabClick.call(n.prev()[0], null, s - 1)), n.remove(), r.eq(s).remove(), setTimeout(function () {
                    f.tabAuto()
                }, 50), cifor.event.call(this, e, "tabDelete(" + c + ")", {elem: o, index: s})
            }, tabAuto: function () {
                var t = "cifor-tab-more", e = "cifor-tab-bar", l = "cifor-tab-close", n = this;
                a(".cifor-tab").each(function () {
                    var s = a(this), o = s.children(".cifor-tab-title"),
                        r = (s.children(".cifor-tab-content").children(".cifor-tab-item"), 'lay-stope="tabmore"'),
                        c = a('<span class="cifor-unselect cifor-tab-bar" ' + r + "><i " + r + ' class="cifor-icon">&#xe61a;</i></span>');
                    if (n === window && 8 != i.ie && f.hideTabMore(!0), s.attr("lay-allowClose") && o.find("li").each(function () {
                        var t = a(this);
                        if (!t.find("." + l)[0]) {
                            var i = a('<i class="cifor-icon cifor-unselect ' + l + '">&#x1006;</i>');
                ...
                var i = a(".cifor-tab-title");
                t !== !0 && "tabmore" === a(t.target).attr("lay-stope") || (i.removeClass("cifor-tab-more"), i.find(".cifor-tab-bar").attr("title", ""))
            }, clickThis: function () {
                var t = a(this), i = t.parents(o), n = i.attr("lay-filter"), s = t.parent(), c = t.siblings("." + d),
                    y = "string" == typeof s.attr("lay-unselect");
                "javascript:;" !== t.attr("href") && "_blank" === t.attr("target") || y || c[0] || (i.find("." + l).removeClass(l), s.addClass(l)), i.hasClass(u) && (c.removeClass(h), c[0] && (s["none" === c.css("display") ? "addClass" : "removeClass"](r + "ed"), "all" === i.attr("lay-shrink") && s.siblings().removeClass(r + "ed"))), cifor.event.call(this, e, "nav(" + n + ")", t)
            }, collapse: function () {
                var t = a(this), i = t.find(".cifor-colla-icon"), l = t.siblings(".cifor-colla-content"),
                    s = t.parents(".cifor-collapse").eq(0), o = s.attr("lay-filter"), r = "none" === l.css("display");
                if ("string" == typeof s.attr("lay-accordion")) {
                    var c = s.children(".cifor-colla-item").children("." + n);
                    c.siblings(".cifor-colla-title").children(".cifor-colla-icon").html("&#xe602;"), c.removeClass(n)
                }
                l[r ? "addClass" : "removeClass"](n), i.html(r ? "&#xe61a;" : "&#xe602;"), cifor.event.call(this, e, "collapse(" + o + ")", {
                    title: t,
                    content: l,
                    show: r
                })
    ...
    s.prototype.init = function (t, e) {
        var l = function () {
            ...
            tab: function () {
                ...
                var t = "cifor-progress";
                a("." + t + l).each(function () {
                    var i = a(this), e = i.find(".cifor-progress-bar"), l = e.attr("lay-percent");
                ...
                var t = "cifor-collapse";
                a("." + t + l).each(function () {
                    var t = a(this).find(".cifor-colla-item");
                    t.each(function () {
                        var t = a(this), i = t.find(".cifor-colla-title"), e = t.find(".cifor-colla-content"),
                            l = "none" === e.css("display");
                        i.find(".cifor-colla-icon").remove(), i.append('<i class="cifor-icon cifor-colla-icon">' + (l ? "&#xe602;" : "&#xe61a;") + "</i>"), i.off("click", f.collapse).on("click", f.collapse)
                    })
                })
            }
        };
        return s[t] ? s[t]() : cifor.each(s, function (t, a) {
            a()
        })
    }, s.prototype.render = s.prototype.init;
    var p = new s, b = a(document);
    p.render();
    var v = ".cifor-tab-title li";
    b.on("click", v, f.tabClick), b.on("click", f.hideTabMore), a(window).on("resize", f.tabAuto), t(e, p)
});
cifor.define("layer", function (e) {
    "use strict";
    var i = cifor.$, t = cifor.layer, n = cifor.hint(), a = cifor.device(), o = {
            config: {}, set: function (e) {
                var t = this;
                return t.config = i.extend({}, t.config, e), t
            }, on: function (e, i) {
                return cifor.onevent.call(this, r, e, i)
            }
        }, l = function () {
            var e = this;
            return {
        ...
        }, r = "upload", u = "cifor-upload-file", c = "cifor-upload-form", f = "cifor-upload-iframe",
        s = "cifor-upload-choose", p = function (e) {
            var t = this;
    ...
    p.prototype.config = {
        ...
        var e = this, t = e.config,
            ...
            o = t.elem.next();
        (o.hasClass(u) || o.hasClass(c)) && o.remove(), a.ie && a.ie < 10 && t.elem.wrap('<div class="cifor-upload-wrap"></div>'), e.isFile() ? (e.elemFile = t.elem, t.field = t.elem[0].name) : t.elem.after(n), a.ie && a.ie < 10 && e.initIE()
        ...
        i("#" + f)[0] || i("body").append(n), t.elem.next().hasClass(c) || (e.elemFile.wrap(a), t.elem.next("." + c).append(function () {
            var e = [];
            return cifor.each(t.data, function (i, t) {
        ...
        var i = this;
        window.FileReader && cifor.each(i.chooseFiles, function (i, t) {
        ...
        var n, o = this, l = o.config, r = o.elemFile[0], u = function () {
            ...
            cifor.each(a, function (e, a) {
                var r = new FormData;
                r.append(l.field, a), cifor.each(l.data, function (e, i) {
            ...
            var i = [];
            return cifor.each(e || o.chooseFiles, function (e, t) {
                i.push(t.name)
            }), i
        }(), g = {
            preview: function (e) {
                ...
                return o.files = o.files || {}, cifor.each(o.chooseFiles, function (e, i) {
                    o.files[e] = i
                }), o.files
        ...
        var e = this, t = e.config, o = function (i) {
            e.chooseFiles = {}, cifor.each(i, function (i, t) {
            ...
            a.next().hasClass(s) && a.next().remove(), e.upload(null, "choose"), e.isFile() || t.choose || a.after('<span class="cifor-inline ' + s + '">' + o + "</span>")
        };
...
cifor.define("jquery", function (e) {
    "use strict";
    var i = cifor.jquery, t = {
            config: {}, index: cifor.slider ? cifor.slider.index + 1e4 : 0, set: function (e) {
                var t = this;
                return t.config = i.extend({}, t.config, e), t
            }, on: function (e, i) {
                return cifor.onevent.call(this, n, e, i)
            }
        }, a = function () {
        ...
        }, n = "slider", l = "cifor-disabled", s = "cifor-slider", r = "cifor-slider-bar", o = "cifor-slider-wrap",
        u = "cifor-slider-wrap-btn", d = "cifor-slider-tips", v = "cifor-slider-input", c = "cifor-slider-input-txt",
        m = "cifor-slider-input-btn", p = "cifor-slider-hover", f = function (e) {
            var a = this;
    ...
    f.prototype.config = {
        ...
        var p = t.disabled ? "#c2c2c2" : t.theme,
            f = '<div class="cifor-slider ' + ("vertical" === t.type ? "cifor-slider-vertical" : "") + '">' + (t.tips ? '<div class="cifor-slider-tips"></div>' : "") + '<div class="cifor-slider-bar" style="background:' + p + "; " + ("vertical" === t.type ? "height" : "width") + ":" + m + ";" + ("vertical" === t.type ? "bottom" : "left") + ":" + (r || 0) + ';"></div><div class="cifor-slider-wrap" style="' + ("vertical" === t.type ? "bottom" : "left") + ":" + (r || m) + ';"><div class="cifor-slider-wrap-btn" style="border: 2px solid ' + p + ';"></div></div>' + (t.range ? '<div class="cifor-slider-wrap" style="' + ("vertical" === t.type ? "bottom" : "left") + ":" + v + ';"><div class="cifor-slider-wrap-btn" style="border: 2px solid ' + p + ';"></div></div>' : "") + "</div>",
            h = i(t.elem), y = h.next("." + s);
        if (y[0] && y.remove(), e.elemTemp = i(f), t.range ? (e.elemTemp.find("." + o).eq(0).data("value", t.value[0]), e.elemTemp.find("." + o).eq(1).data("value", t.value[1])) : e.elemTemp.find("." + o).data("value", t.value), h.html(e.elemTemp), "vertical" === t.type && e.elemTemp.height(t.height + "px"), t.showstep) {
            for (var g = (t.max - t.min) / t.step, b = "", x = 1; x < g + 1; x++) {
                var T = 100 * x / g;
                T < 100 && (b += '<div class="cifor-slider-step" style="' + ("vertical" === t.type ? "bottom" : "left") + ":" + T + '%"></div>')
            }
            e.elemTemp.append(b)
        }
        if (t.input && !t.range) {
            var w = i('<div class="cifor-slider-input cifor-input"><div class="cifor-slider-input-txt"><input type="text" class="cifor-input"></div><div class="cifor-slider-input-btn"><i class="cifor-icon cifor-icon-up"></i><i class="cifor-icon cifor-icon-down"></i></div></div>');
        ...
        var n = this, l = n.config, s = n.elemTemp, f = function () {
            ...
            }, w = i(['<div class="cifor-auxiliar-moving" id="LAY-slider-moving"></div'].join("")), M = function (e, t) {
                var a = function () {
                    t && t(), w.remove()
                };
...
cifor.define("jquery", function (e) {
    "use strict";
    var i = cifor.jquery, o = {
            config: {}, index: cifor.colorpicker ? cifor.colorpicker.index + 1e4 : 0, set: function (e) {
                var o = this;
                return o.config = i.extend({}, o.config, e), o
            }, on: function (e, i) {
                return cifor.onevent.call(this, "colorpicker", e, i)
            }
        }, r = function () {
            var e = this, i = e.config;
            return {config: i}
        }, t = "colorpicker", n = "cifor-show", l = "cifor-colorpicker", c = ".cifor-colorpicker-main",
        a = "cifor-icon-down", s = "cifor-icon-close", f = "cifor-colorpicker-trigger-span",
        d = "cifor-colorpicker-trigger-i", u = "cifor-colorpicker-side", p = "cifor-colorpicker-side-slider",
        g = "cifor-colorpicker-basis", v = "cifor-colorpicker-alpha-bgcolor", h = "cifor-colorpicker-alpha-slider",
        m = "cifor-colorpicker-basis-cursor", b = "cifor-colorpicker-main-input", k = function (e) {
    ...
    D.prototype.config = {
        ...
        var e = this, o = e.config,
            r = i(['<div class="cifor-unselect cifor-colorpicker">', "<span " + ("rgb" == o.format && o.alpha ? 'class="cifor-colorpicker-trigger-bgcolor"' : "") + ">", '<span class="cifor-colorpicker-trigger-span" ', 'lay-type="' + ("rgb" == o.format ? o.alpha ? "rgba" : "torgb" : "") + '" ', 'style="' + function () {
                var e = "";
                return o.color ? (e = o.color, (o.color.match(/[0-9]{1,3}/g) || []).length > 3 && (o.alpha && "rgb" == o.format || (e = "#" + C(k(P(o.color))))), "background: " + e) : e
            }() + '">', '<i class="cifor-icon cifor-colorpicker-trigger-i ' + (o.color ? a : s) + '"></i>', "</span>", "</span>", "</div>"].join("")),
            t = i(o.elem);
        o.size && r.addClass("cifor-colorpicker-" + o.size), t.addClass("cifor-inline").html(e.elemColorBox = r), e.color = e.elemColorBox.find("." + f)[0].style.background, e.events()
    }, D.prototype.renderPicker = function () {
        var e = this, o = e.config, r = e.elemColorBox[0],
            t = e.elemPicker = i(['<div id="cifor-colorpicker' + e.index + '" data-index="' + e.index + '" class="cifor-anim cifor-anim-upbit cifor-colorpicker-main">', '<div class="cifor-colorpicker-main-wrapper">', '<div class="cifor-colorpicker-basis">', '<div class="cifor-colorpicker-basis-white"></div>', '<div class="cifor-colorpicker-basis-black"></div>', '<div class="cifor-colorpicker-basis-cursor"></div>', "</div>", '<div class="cifor-colorpicker-side">', '<div class="cifor-colorpicker-side-slider"></div>', "</div>", "</div>", '<div class="cifor-colorpicker-main-alpha ' + (o.alpha ? n : "") + '">', '<div class="cifor-colorpicker-alpha-bgcolor">', '<div class="cifor-colorpicker-alpha-slider"></div>', "</div>", "</div>", function () {
                if (o.predefine) {
                    var e = ['<div class="cifor-colorpicker-main-pre">'];
                    return cifor.each(o.colors, function (i, o) {
                        e.push(['<div class="cifor-colorpicker-pre' + ((o.match(/[0-9]{1,3}/g) || []).length > 3 ? " cifor-colorpicker-pre-isalpha" : "") + '">', '<div style="background:' + o + '"></div>', "</div>"].join(""))
                    }), e.push("</div>"), e.join("")
                }
                return ""
            }(), '<div class="cifor-colorpicker-main-input">', '<div class="cifor-inline">', '<input type="text" class="cifor-input">', "</div>", '<div class="cifor-btn-container">', '<button class="cifor-btn cifor-btn-primary cifor-btn-sm" colorpicker-events="clear">清空</button>', '<button class="cifor-btn cifor-btn-sm" colorpicker-events="confirm">确定</button>', "</div", "</div>", "</div>"].join(""));
        ...
        var o = this;
        o.config;
        return i("#cifor-colorpicker" + (e || o.index)).remove(), o
        ...
        var e = this, o = e.config, r = e.elemColorBox.find("." + f), t = r.attr("lay-type"),
            ...
            j = e.elemColorBox.find("." + d), F = e.elemPicker.find(".cifor-colorpicker-pre").children("div"),
            L = function (i, n, l, c) {
                e.select(i, n, l);
                var f = x({h: i, s: n, b: l});
            ...
            }, M = i(['<div class="cifor-auxiliar-moving" id="LAY-colorpicker-moving"></div'].join("")),
            Y = function (e) {
        ...
        l.on("mousedown", function (e) {
            ...
            cifor.stope(e), Y(n), e.preventDefault()
            ...
            i(this).on("click", function () {
                i(this).parent(".cifor-colorpicker-pre").addClass("selected").siblings().removeClass("selected");
...
cifor.define("layer", function (e) {
    "use strict";
    var t = cifor.$, i = cifor.layer, a = cifor.hint(), n = cifor.device(), l = "form", r = ".cifor-form",
        s = "cifor-this", o = "cifor-hide", c = "cifor-disabled", u = function () {
            this.config = {
                verify: {
                    required: [/[\S]+/, "必填项不能为空"],
    ...
    u.prototype.set = function (e) {
        ...
        return cifor.onevent.call(this, l, e, t)
    }, u.prototype.val = function (e, i) {
        var a = t(r + '[lay-filter="' + e + '"]');
        a.each(function (e, a) {
            var n = t(this);
            cifor.each(i, function (e, t) {
        ...
        var n = this, u = t(r + function () {
            ...
            select: function () {
                var e, i = "请选择", a = "cifor-form-select", n = "cifor-select-title", r = "cifor-select-none", d = "",
                    f = u.find("select"), v = function (i, l) {
                        ...
                        if (!u) {
                            ...
                            }), m.find(".cifor-edge").on("click", function () {
                                k.focus()
                            ...
                            f && k.on("keyup", j).on("blur", function (i) {
                                ...
                                return !e.hasClass(c) && (e.hasClass("cifor-select-tips") ? k.val("") : (k.val(e.text()), e.addClass(s)), e.siblings().removeClass(s), p.val(a).removeClass("cifor-form-danger"), cifor.event.call(this, l, "select(" + n + ")", {
                                    elem: p[0],
                                    value: a,
                                    othis: i
                                }), w(!0), !1)
                ...
                f.each(function (e, l) {
                    ...
                    var h = "string" == typeof r.attr("lay-search"), p = v ? v.value ? i : v.innerHTML || i : i,
                        m = t(['<div class="' + (h ? "" : "cifor-unselect ") + a, (u ? " cifor-select-disabled" : "") + '">', '<div class="' + n + '">', '<input type="text" placeholder="' + p + '" ' + ('value="' + (d ? f.html() : "") + '"') + (h ? "" : " readonly") + ' class="cifor-input' + (h ? "" : " cifor-unselect") + (u ? " " + c : "") + '">', '<i class="cifor-edge"></i></div>', '<dl class="cifor-anim cifor-anim-upbit' + (r.find("optgroup")[0] ? " cifor-select-group" : "") + '">', function (e) {
                            var t = [];
                            return cifor.each(e, function (e, a) {
                                0 !== e || a.value ? "optgroup" === a.tagName.toLowerCase() ? t.push("<dt>" + a.label + "</dt>") : t.push('<dd lay-value="' + a.value + '" class="' + (d === a.value ? s : "") + (a.disabled ? " " + c : "") + '">' + a.innerHTML + "</dd>") : t.push('<dd lay-value="" class="cifor-select-tips">' + (a.innerHTML || i) + "</dd>")
                ...
                var e = {
                    checkbox: ["cifor-form-checkbox", "cifor-form-checked", "checkbox"],
                    _switch: ["cifor-form-switch", "cifor-form-onswitch", "switch"]
                }, i = u.find("input[type=checkbox]"), a = function (e, i) {
                    var a = t(this);
                    e.on("click", function () {
                        var t = a.attr("lay-filter"), n = (a.attr("lay-text") || "").split("|");
                        a[0].disabled || (a[0].checked ? (a[0].checked = !1, e.removeClass(i[1]).find("em").text(n[1])) : (a[0].checked = !0, e.addClass(i[1]).find("em").text(n[0])), cifor.event.call(a[0], l, i[2] + "(" + t + ")", {
                            elem: a[0],
                            value: a[0].value,
                            othis: e
                        }))
                ...
                i.each(function (i, n) {
                    ...
                    var d = l.next("." + u[0]),
                        f = t(['<div class="cifor-unselect ' + u[0], n.checked ? " " + u[1] : "", o ? " cifor-checkbox-disbaled " + c : "", '"', r ? ' lay-skin="' + r + '"' : "", ">", function () {
                            var e = n.title.replace(/\s/g, ""), t = {
                                checkbox: [e ? "<span>" + n.title + "</span>" : "", '<i class="cifor-icon cifor-icon-ok"></i>'].join(""),
                ...
                var e = "cifor-form-radio", i = ["&#xe643;", "&#xe63f;"], a = u.find("input[type=radio]"),
                    n = function (a) {
                        var n = t(this), s = "cifor-anim-scaleSpring";
                        a.on("click", function () {
                            var o = n[0].name, c = n.parents(r), u = n.attr("lay-filter"),
                                d = c.find("input[name=" + o.replace(/(\.|#|\[|\])/g, "\\$1") + "]");
                            n[0].disabled || (cifor.each(d, function () {
                                var a = t(this).next("." + e);
                                this.checked = !1, a.removeClass(e + "ed"), a.find(".cifor-icon").removeClass(s).html(i[1])
                            }), n[0].checked = !0, a.addClass(e + "ed"), a.find(".cifor-icon").addClass(s).html(i[0]), cifor.event.call(n[0], l, "radio(" + u + ")", {
                                elem: n[0],
                                value: n[0].value,
                                othis: a
                            }))
                ...
                a.each(function (a, l) {
                    ...
                    if ("string" == typeof r.attr("lay-ignore")) return r.show();
                    s[0] && s.remove();
                    var u = t(['<div class="cifor-unselect ' + e, l.checked ? " " + e + "ed" : "", (o ? " cifor-radio-disbaled " + c : "") + '">', '<i class="cifor-anim cifor-icon">' + i[l.checked ? 0 : 1] + "</i>", "<div>" + function () {
                        var e = l.title || "";
        ...
        return e ? d[e] ? d[e]() : a.error("不支持的" + e + "表单渲染") : cifor.each(d, function (e, t) {
            t()
        }), n
    };
    var d = function () {
        var e = t(this), a = f.config.verify, s = null, o = "cifor-form-danger", c = {}, u = e.parents(r),
            d = u.find("*[lay-verify]"), v = e.parents("form")[0], h = u.find("input,select,textarea"),
            y = e.attr("lay-filter");
        if (cifor.each(d, function (e, l) {
            var r = t(this), c = r.attr("lay-verify").split("|"), u = r.attr("lay-verType"), d = r.val();
            if (r.removeClass(o), cifor.each(c, function (e, t) {
        ...
        var p = {};
        return cifor.each(h, function (e, t) {
        ...
        }), cifor.event.call(this, l, "submit(" + y + ")", {elem: this, form: v, field: c})
...
cifor.define("jquery", function (e) {
    "use strict";
    var o = cifor.$, a = cifor.hint(), i = "cifor-tree-enter", r = function (e) {
        this.options = e
    }, t = {
        arrow: ["&#xe623;", "&#xe625;"],
        checkbox: ["&#xe626;", "&#xe627;"],
    ...
    r.prototype.init = function (e) {
        var o = this;
        e.addClass("cifor-box cifor-tree"), o.options.skin && e.addClass("cifor-tree-skin-" + o.options.skin), o.tree(e), o.on(e)
    }, r.prototype.tree = function (e, a) {
        var i = this, r = i.options, n = a || r.nodes;
        cifor.each(n, function (a, n) {
            var l = n.children && n.children.length > 0,
                c = o('<ul class="' + (n.spread ? "cifor-show" : "") + '"></ul>'),
                s = o(["<li " + (n.spread ? 'data-spread="' + n.spread + '"' : "") + ">", function () {
                    return l ? '<i class="cifor-icon cifor-tree-spread">' + (n.spread ? t.arrow[1] : t.arrow[0]) + "</i>" : ""
                }(), function () {
                    return r.check ? '<i class="cifor-icon cifor-tree-check">' + ("checkbox" === r.check ? t.checkbox[0] : "radio" === r.check ? t.radio[0] : "") + "</i>" : ""
                }(), function () {
                    return '<a href="' + (n.href || "javascript:;") + '" ' + (r.target && n.href ? 'target="' + r.target + '"' : "") + ">" + ('<i class="cifor-icon cifor-tree-' + (l ? "branch" : "leaf") + '">' + (l ? n.spread ? t.branch[1] : t.branch[0] : t.leaf) + "</i>") + ("<cite>" + (n.name || "未命名") + "</cite></a>")
                }(), "</li>"].join(""));
        ...
        e.children("a").on("click", function (e) {
            cifor.stope(e), i.click(o)
        })
    }, r.prototype.spread = function (e, o) {
        var a = this, i = (a.options, e.children(".cifor-tree-spread")), r = e.children("ul"), n = e.children("a"),
            l = function () {
                e.data("spread") ? (e.data("spread", null), r.removeClass("cifor-show"), i.html(t.arrow[0]), n.find(".cifor-icon").html(t.branch[0])) : (e.data("spread", !0), r.addClass("cifor-show"), i.html(t.arrow[1]), n.find(".cifor-icon").html(t.branch[1]))
            };
        r[0] && (i.on("click", l), n.on("dblclick", l))
    }, r.prototype.on = function (e) {
        var a = this, r = a.options, t = "cifor-tree-drag";
        e.find("i").on("selectstart", function (e) {
            return !1
        }), r.drag && o(document).on("mousemove", function (e) {
            var i = a.move;
            if (i.from) {
                var r = (i.to, o('<div class="cifor-box ' + t + '"></div>'));
                e.preventDefault(), o("." + t)[0] || o("body").append(r);
                var n = o("." + t)[0] ? o("." + t) : r;
                n.addClass("cifor-show").html(i.from.elem.children("a").html()), n.css({
                    left: e.pageX + 10,
                    top: e.pageY + 10
                })
            }
        ...
        return t[0] ? void i.init(t) : a.error("cifor.tree 没有找到" + e.elem + "元素")
    })
});
cifor.define(["laytpl", "laypage", "layer", "form", "util"], function (e) {
    "use strict";
    var t = cifor.$, i = cifor.laytpl, a = cifor.laypage, l = cifor.layer, n = cifor.form,
        o = (cifor.util, cifor.hint()), r = cifor.device(), d = {
            config: {checkName: "LAY_CHECKED", indexName: "LAY_TABLE_INDEX"},
            cache: {},
            index: cifor.table ? cifor.table.index + 1e4 : 0,
            set: function (e) {
                var i = this;
                return i.config = t.extend({}, i.config, e), i
            },
            on: function (e, t) {
                return cifor.onevent.call(this, u, e, t)
            }
        }, c = function () {
        ...
        }, u = "table", h = ".cifor-table", y = "cifor-hide", f = "cifor-none", p = "cifor-table-view",
        v = ".cifor-table-tool", m = ".cifor-table-box", g = ".cifor-table-init", b = ".cifor-table-header",
        x = ".cifor-table-body", k = ".cifor-table-main", C = ".cifor-table-fixed", w = ".cifor-table-fixed-l",
        T = ".cifor-table-fixed-r", A = ".cifor-table-total", L = ".cifor-table-page", S = ".cifor-table-sort",
        N = "cifor-table-edit", W = "cifor-table-hover", _ = function (e) {
            var t = '{{#if(item2.colspan){}} colspan="{{item2.colspan}}"{{#} if(item2.rowspan){}} rowspan="{{item2.rowspan}}"{{#}}}';
            return e = e || {}, ['<table cellspacing="0" cellpadding="0" border="0" class="cifor-table" ', '{{# if(d.data.skin){ }}lay-skin="{{d.data.skin}}"{{# } }} {{# if(d.data.size){ }}lay-size="{{d.data.size}}"{{# } }} {{# if(d.data.even){ }}lay-even{{# } }}>', "<thead>", "{{# cifor.each(d.data.cols, function(i1, item1){ }}", "<tr>", "{{# cifor.each(item1, function(i2, item2){ }}", '{{# if(item2.fixed && item2.fixed !== "right"){ left = true; } }}', '{{# if(item2.fixed === "right"){ right = true; } }}', function () {
                return e.fixed && "right" !== e.fixed ? '{{# if(item2.fixed && item2.fixed !== "right"){ }}' : "right" === e.fixed ? '{{# if(item2.fixed === "right"){ }}' : ""
            }(), "{{# var isSort = !(item2.colGroup) && item2.sort; }}", '<th data-field="{{ item2.field||i2 }}" data-key="{{d.index}}-{{i1}}-{{i2}}" {{# if( item2.parentKey){ }}data-parentkey="{{ item2.parentKey }}"{{# } }} {{# if(item2.minWidth){ }}data-minwidth="{{item2.minWidth}}"{{# } }} ' + t + ' {{# if(item2.unresize || item2.colGroup){ }}data-unresize="true"{{# } }} class="{{# if(item2.hide){ }}cifor-hide{{# } }}{{# if(isSort){ }} cifor-unselect{{# } }}{{# if(!item2.field){ }} cifor-table-col-special{{# } }}">', '<div class="cifor-table-cell laytable-cell-', "{{# if(item2.colGroup){ }}", "group", "{{# } else { }}", "{{d.index}}-{{i1}}-{{i2}}", '{{# if(item2.type !== "normal"){ }}', " laytable-cell-{{ item2.type }}", "{{# } }}", "{{# } }}", '" {{#if(item2.align){}}align="{{item2.align}}"{{#}}}>', '{{# if(item2.type === "checkbox"){ }}', '<input type="checkbox" name="layTableCheckbox" lay-skin="primary" lay-filter="layTableAllChoose" {{# if(item2[d.data.checkName]){ }}checked{{# }; }}>', "{{# } else { }}", '<span>{{item2.title||""}}</span>', "{{# if(isSort){ }}", '<span class="cifor-table-sort cifor-inline"><i class="cifor-edge cifor-table-sort-asc" title="升序"></i><i class="cifor-edge cifor-table-sort-desc" title="降序"></i></span>', "{{# } }}", "{{# } }}", "</div>", "</th>", e.fixed ? "{{# }; }}" : "", "{{# }); }}", "</tr>", "{{# }); }}", "</thead>", "</table>"].join("")
        },
        E = ['<table cellspacing="0" cellpadding="0" border="0" class="cifor-table" ', '{{# if(d.data.skin){ }}lay-skin="{{d.data.skin}}"{{# } }} {{# if(d.data.size){ }}lay-size="{{d.data.size}}"{{# } }} {{# if(d.data.even){ }}lay-even{{# } }}>', "<tbody></tbody>", "</table>"].join(""),
        z = ['<div class="cifor-form cifor-border-box {{d.VIEW_CLASS}}" lay-filter="LAY-table-{{d.index}}" lay-id="{{ d.data.id }}" style="{{# if(d.data.width){ }}width:{{d.data.width}}px;{{# } }} {{# if(d.data.height){ }}height:{{d.data.height}}px;{{# } }}">', "{{# if(d.data.toolbar){ }}", '<div class="cifor-table-tool">', '<div class="cifor-table-tool-temp"></div>', '<div class="cifor-table-tool-self"></div>', "</div>", "{{# } }}", '<div class="cifor-table-box">', "{{# if(d.data.loading){ }}", '<div class="cifor-table-init" style="background-color: #fff;">', '<i class="cifor-icon cifor-icon-loading cifor-icon"></i>', "</div>", "{{# } }}", "{{# var left, right; }}", '<div class="cifor-table-header">', _(), "</div>", '<div class="cifor-table-body cifor-table-main">', E, "</div>", "{{# if(left){ }}", '<div class="cifor-table-fixed cifor-table-fixed-l">', '<div class="cifor-table-header">', _({fixed: !0}), "</div>", '<div class="cifor-table-body">', E, "</div>", "</div>", "{{# }; }}", "{{# if(right){ }}", '<div class="cifor-table-fixed cifor-table-fixed-r">', '<div class="cifor-table-header">', _({fixed: "right"}), '<div class="cifor-table-mend"></div>', "</div>", '<div class="cifor-table-body">', E, "</div>", "</div>", "{{# }; }}", "</div>", "{{# if(d.data.totalRow){ }}", '<div class="cifor-table-total">', '<table cellspacing="0" cellpadding="0" border="0" class="cifor-table" ', '{{# if(d.data.skin){ }}lay-skin="{{d.data.skin}}"{{# } }} {{# if(d.data.size){ }}lay-size="{{d.data.size}}"{{# } }} {{# if(d.data.even){ }}lay-even{{# } }}>', '<tbody><tr><td><div class="cifor-table-cell" style="visibility: hidden;">Total</div></td></tr></tbody>', "</table>", "</div>", "{{# } }}", "{{# if(d.data.page){ }}", '<div class="cifor-table-page">', '<div id="cifor-table-page{{d.index}}"></div>', "</div>", "{{# } }}", "<style>", "{{# cifor.each(d.data.cols, function(i1, item1){", "cifor.each(item1, function(i2, item2){ }}", ".laytable-cell-{{d.index}}-{{i1}}-{{i2}}{ ", "{{# if(item2.width){ }}", "width: {{item2.width}}px;", "{{# } }}", " }", "{{# });", "}); }}", "</style>", "</div>"].join(""),
    ...
    F.prototype.config = {
        ...
        return i.clientWidth = i.width || function () {
            ...
            return e()
        }(), "width" === e ? i.clientWidth : void cifor.each(i.cols, function (e, a) {
            cifor.each(a, function (l, n) {
                if (!n) return void a.splice(l, 1);
                if (n.key = e + "-" + l, n.hide = n.hide || !1, n.colGroup || n.colspan > 1) {
                    var o = 0;
                    cifor.each(i.cols[e + 1], function (t, i) {
        ...
        var e = this, a = e.config,
            l = ['<div class="cifor-inline" lay-event="add"><i class="cifor-icon cifor-icon-add-1"></i></div>', '<div class="cifor-inline" lay-event="update"><i class="cifor-icon cifor-icon-edit"></i></div>', '<div class="cifor-inline" lay-event="delete"><i class="cifor-icon cifor-icon-delete"></i></div>'].join(""),
            n = e.layTool.find(".cifor-table-tool-temp");
        if ("default" === a.toolbar) n.html(l); else if ("string" == typeof a.toolbar) {
            var o = t(a.toolbar).html() || "";
            o && n.html(i(o).render(a))
        }
        var r = {
            filter: {title: "筛选列", layEvent: "LAYTABLE_COLS", icon: "cifor-icon-cols"},
            exports: {title: "导出", layEvent: "LAYTABLE_EXPORT", icon: "cifor-icon-export"},
            print: {title: "打印", layEvent: "LAYTABLE_PRINT", icon: "cifor-icon-print"}
        }, d = [];
        "object" == typeof a.defaultToolbar && cifor.each(a.defaultToolbar, function (e, t) {
            var i = r[t];
            i && d.push('<div class="cifor-inline" title="' + i.title + '" lay-event="' + i.layEvent + '"><i class="cifor-icon ' + i.icon + '"></i></div>')
        }), e.layTool.find(".cifor-table-tool-self").html(d.join(""))
        ...
        var e = this, t = e.config;
        cifor.each(t.cols, function (t, i) {
            cifor.each(i, function (t, i) {
        ...
        var r = function (e) {
            cifor.each(t.cols, function (i, r) {
                cifor.each(r, function (i, d) {
        ...
        var c = this, s = c.config, u = e[s.response.dataName] || [], h = [], p = [], v = [], m = function () {
            var e;
            return !r && c.sortKey ? c.sort(c.sortKey.field, c.sortKey.sort, !0) : (cifor.each(u, function (a, l) {
                ...
                0 !== l.length && (r || (l[d.config.indexName] = a), c.eachCols(function (n, r) {
                    ...
                    if (void 0 !== p && null !== p || (p = ""), !r.colGroup) {
                        var v = ['<td data-field="' + c + '" data-key="' + h + '" ' + function () {
                            ...
                            var e = [];
                            return r.hide && e.push(y), r.field || e.push("cifor-table-col-special"), e.join(" ")
                        }() + '">', '<div class="cifor-table-cell laytable-cell-' + function () {
        ...
        return c.key = s.id || s.index, d.cache[c.key] = u, c.layPage[0 == o || 0 === u.length && 1 == n ? "addClass" : "removeClass"](y), r ? m() : 0 === u.length ? (c.renderForm(), c.layFixed.remove(), c.layMain.find("tbody").html(""), c.layMain.find("." + f).remove(), c.layMain.append('<div class="' + f + '">' + s.text.none + "</div>")) : (m(), c.renderTotal(u), void (s.page && (s.page = t.extend({
            elem: "cifor-table-page" + s.index,
            count: o,
            limit: s.limit,
            limits: s.limits || [10, 20, 30, 40, 50, 60, 70, 80, 90],
            groups: 3,
            layout: ["prev", "page", "next", "skip", "count", "limit"],
            prev: '<i class="cifor-icon">&#xe603;</i>',
            next: '<i class="cifor-icon">&#xe602;</i>',
            jump: function (e, t) {
            ...
            t.eachCols(function (e, t) {
                var n = t.field || e,
                    o = ['<td data-field="' + n + '" data-key="' + i.index + "-" + t.key + '" ' + function () {
                        ...
                        var e = [];
                        return t.hide && e.push(y), t.field || e.push("cifor-table-col-special"), e.join(" ")
                    }() + '">', '<div class="cifor-table-cell laytable-cell-' + function () {
                        var e = i.index + "-" + t.key;
        ...
        var t = this, i = (t.config, "cifor-table-click"), a = t.layBody.find('tr[data-index="' + e + '"]');
        ...
        c.sortKey = {
            field: n,
            sort: i
        }, h.autoSort && ("asc" === i ? r = cifor.sort(f, n) : "desc" === i ? r = cifor.sort(f, n, !0) : (r = cifor.sort(f, d.config.indexName), delete c.sortKey)), s[h.response.dataName] = r || f, c.renderData(s, c.page, c.count, !0), l && cifor.event.call(e, u, "sort(" + y + ")", {
            field: n,
            type: i
        })
    }, F.prototype.loading = function (e) {
        var i = this, a = i.config;
        a.loading && (e ? (i.layInit && i.layInit.remove(), delete i.layInit, i.layBox.find(g).remove()) : (i.layInit = t(['<div class="cifor-table-init">', '<i class="cifor-icon cifor-icon-loading cifor-icon"></i>', "</div>"].join("")), i.layBox.append(i.layInit)))
        ...
        var e = this, i = e.layMain.children("table"), a = e.layMain.width() - e.layMain.prop("clientWidth"),
            ...
            n = (e.getScrollWidth(e.layMain[0]), i.outerWidth() - e.layMain.width()), o = function (e) {
                if (a && l) {
                    if (e = e.eq(0), !e.find(".cifor-table-patch")[0]) {
                        var i = t('<th class="cifor-table-patch"><div class="cifor-table-cell"></div></th>');
                        i.find("div").css({width: a}), e.find("tr").append(i)
                    }
                } else e.find(".cifor-table-patch").remove()
            };
        ...
        var e, a = this, o = a.config, c = t("body"), s = {}, h = a.layHeader.find("th"), f = ".cifor-table-cell",
            p = o.elem.attr("lay-filter");
        a.layTool.on("click", "*[lay-event]", function (e) {
            var i = t(this), c = i.attr("lay-event"), s = function (e) {
                var l = t(e.list), n = t('<ul class="cifor-table-tool-panel"></ul>');
                n.html(l), o.height && n.css("max-height", o.height - (a.layTool.outerHeight() || 50)), i.find(".cifor-table-tool-panel")[0] || i.append(n), a.renderForm(), n.on("click", function (e) {
                    cifor.stope(e)
                }), e.done && e.done(n, l)
            };
            switch (cifor.stope(e), R.trigger("table.tool.panel.remove"), l.close(a.tipsIndex), c) {
                case"LAYTABLE_COLS":
                    s({
                        list: function () {
                            var e = [];
                            ...
                            n.on("checkbox(LAY_TABLE_TOOL_COLS)", function (e) {
                                ...
                                cifor.each(o.cols, function (e, t) {
                                    cifor.each(t, function (t, i) {
                                        if (e + "-" + t === n) {
                                            var d = i.hide;
                ...
                case"LAYTABLE_PRINT":
                    var h = window.open("打印窗口", "_blank"),
                        f = ["<style>", "body{font-size: 12px; color: #666;}", "table{width: 100%; border-collapse: collapse; border-spacing: 0;}", "th,td{line-height: 20px; padding: 9px 15px; border: 1px solid #ccc; text-align: left; font-size: 12px; color: #666;}", "a{color: #666; text-decoration:none;}", "*.cifor-hide{display: none}", "</style>"].join(""),
                        v = t(a.layHeader.html());
                    v.append(a.layMain.find("table").html()), v.find("th.cifor-table-patch").remove(), v.find(".cifor-table-col-special").remove(), h.document.write(f + v.prop("outerHTML")), h.document.close(), h.print(), h.close()
            }
            cifor.event.call(this, u, "toolbar(" + p + ")", t.extend({event: c, config: o}, {}))
        ...
        }).find(S + " .cifor-edge ").on("click", function (e) {
            var i = t(this), l = i.index(), n = i.parents("th").eq(0).data("field");
            cifor.stope(e), 0 === l ? a.sort(n, "asc", null, !0) : a.sort(n, "desc", null, !0)
        });
        var v = function (e) {
        ...
        a.elem.on("click", 'input[name="layTableCheckbox"]+', function () {
            ...
            }), a.syncCheckAll(), a.renderForm("checkbox")) : (a.setCheckData(l, n), a.syncCheckAll()), cifor.event.call(e[0], u, "checkbox(" + p + ")", v.call(e[0], {
                checked: n,
                type: o ? "all" : "one"
            }))
            ...
            cifor.each(l, function (e, t) {
                n === e ? t.LAY_CHECKED = !0 : delete t.LAY_CHECKED
            }), a.setThisRowChecked(n), cifor.event.call(this, u, "radio(" + p + ")", v.call(this, {checked: i}))
        ...
        var m = function (e) {
            var i = t(this);
            cifor.event.call(this, u, e + "(" + p + ")", v.call(i.children("td")[0]))
        };
        a.layBody.on("change", "." + N, function () {
            var e = t(this), i = this.value, l = e.parent().data("field"), n = e.parents("tr").eq(0).data("index"),
                o = d.cache[a.key][n];
            o[l] = i, cifor.event.call(this, u, "edit(" + p + ")", v.call(this, {value: i, field: l}))
        }).on("blur", "." + N, function () {
            ...
            if (!i.data("off") && a) {
                var n = t('<input class="cifor-input ' + N + '">');
                return n[0].value = i.data("content") || l.text(), i.find("." + N)[0] || i.append(n), n.focus(), void cifor.stope(e)
            }
        ...
        var g = "cifor-table-grid-down", b = function (e) {
            var i = t(this), a = i.children(f);
            if (e) i.find(".cifor-table-grid-down").remove(); else if (a.prop("scrollWidth") > a.outerWidth()) {
                if (a.find("." + g)[0]) return;
                i.append('<div class="' + g + '"><i class="cifor-icon cifor-icon-down"></i></div>')
            }
        };
        a.layBody.on("click", "." + g, function (e) {
            var i = t(this), n = i.parent(), d = n.children(f);
            a.tipsIndex = l.tips(['<div class="cifor-table-tips-main" style="margin-top: -' + (d.height() + 16) + "px;" + function () {
                return "sm" === o.size ? "padding: 4px 15px; font-size: 12px;" : "lg" === o.size ? "padding: 14px 15px;" : ""
            }() + '">', d.html(), "</div>", '<i class="cifor-icon cifor-table-tips-c cifor-icon-close"></i>'].join(""), d[0], {
                tips: [3, ""],
                time: -1,
                anim: -1,
                maxWidth: r.ios || r.android ? 300 : a.elem.width() / 2,
                isOutAnim: !1,
                skin: "cifor-table-tips",
                success: function (e, t) {
                    e.find(".cifor-table-tips-c").on("click", function () {
                        l.close(t)
                    })
                }
            }), cifor.stope(e)
            ...
            cifor.event.call(this, u, "tool(" + p + ")", v.call(this, {event: e.attr("lay-event")})), a.setThisRowChecked(i)
            ...
            t(".cifor-table-tool-panel").remove()
        ...
        a = t.extend(!0, [], a || l.cols), cifor.each(a, function (e, t) {
            cifor.each(t, function (t, i) {
                if (i.colGroup) {
                    var l = 0;
                    o++, i.CHILD_COLS = [], cifor.each(a[e + 1], function (e, t) {
        ...
        return cifor.each(l, function (e, l) {
        ...
        return r.ie ? o.error("IE_NOT_SUPPORT_EXPORTS") : (n.href = "data:" + l + ";charset=utf-8,\ufeff" + encodeURIComponent(function () {
            var i = [], a = [];
            return cifor.each(t, function (t, l) {
                var n = [];
                "object" == typeof e ? (cifor.each(e, function (e, a) {
                    0 == t && i.push(a || "")
                }), cifor.each(d.clearCacheKey(l), function (e, t) {
                    n.push(t)
        ...
        if (e) {
            ...
            if (!t) return;
            c.that[e].resize()
        } else cifor.each(c.that, function () {
            this.resize()
        })
...
cifor.define("jquery", function (e) {
    "use strict";
    var i = cifor.$, n = (cifor.hint(), cifor.device(), {
            config: {}, set: function (e) {
                var n = this;
                return n.config = i.extend({}, n.config, e), n
            }, on: function (e, i) {
                return cifor.onevent.call(this, t, e, i)
            }
        }), t = "carousel", a = "cifor-this", l = ">*[carousel-item]>*", o = "cifor-carousel-left",
        r = "cifor-carousel-right", d = "cifor-carousel-prev", s = "cifor-carousel-next", u = "cifor-carousel-arrow",
        c = "cifor-carousel-ind", m = function (e) {
            var t = this;
    ...
    m.prototype.config = {
        ...
        var e = this, n = e.config,
            t = i(['<button class="cifor-icon ' + u + '" lay-type="sub">' + ("updown" === n.anim ? "&#xe619;" : "&#xe603;") + "</button>", '<button class="cifor-icon ' + u + '" lay-type="add">' + ("updown" === n.anim ? "&#xe61a;" : "&#xe602;") + "</button>"].join(""));
        ...
        var e = this, n = e.config, t = e.elemInd = i(['<div class="' + c + '"><ul>', function () {
            var i = [];
            return cifor.each(e.elemItem, function (e) {
                i.push("<li" + (n.index === e ? ' class="cifor-this"' : "") + "></li>")
            }), i.join("")
        }(), "</ul></div>"].join(""));
        ...
        }, 300), n.elemInd.find("li").eq(u.index).addClass(a).siblings().removeClass(a), n.haveSlide = !0, cifor.event.call(this, t, "change(" + m + ")", {
            index: u.index,
            prevIndex: c,
            item: l.eq(u.index)
        }))
...
cifor.define("jquery", function (e) {
    "use strict";
    var a = cifor.jquery, i = {
            config: {}, index: cifor.rate ? cifor.rate.index + 1e4 : 0, set: function (e) {
                var i = this;
                return i.config = a.extend({}, i.config, e), i
            }, on: function (e, a) {
                return cifor.onevent.call(this, n, e, a)
            }
        }, l = function () {
            var e = this, a = e.config;
            return {
        ...
        }, n = "rate", t = "cifor-rate", o = "cifor-icon-rate", s = "cifor-icon-rate-solid", u = "cifor-icon-rate-half",
        r = "cifor-icon-rate-solid cifor-icon-rate-half", c = "cifor-icon-rate-solid cifor-icon-rate",
        f = "cifor-icon-rate cifor-icon-rate-half", v = function (e) {
            var l = this;
    ...
    v.prototype.config = {
        ...
        for (var n = '<ul class="cifor-rate" ' + (i.readonly ? "readonly" : "") + ">", u = 1; u <= i.length; u++) {
            var r = '<li class="cifor-inline"><i class="cifor-icon ' + (u > Math.floor(i.value) ? o : s) + '" ' + l + "></i></li>";
            i.half && parseInt(i.value) !== i.value && u == Math.ceil(i.value) ? n = n + '<li><i class="cifor-icon cifor-icon-rate-half" ' + l + "></i></li>" : n += r
        }
        n += "</ul>" + (i.text ? '<span class="cifor-inline">' + i.value + "星" : "") + "</span>";
        var c = i.elem, f = c.next("." + t);
        f[0] && f.remove(), e.elemTemp = a(n), i.span = e.elemTemp.next("span"), i.setText && i.setText(i.value), c.html(e.elemTemp), c.addClass("cifor-inline"), i.readonly || e.action()
...
cifor.define("jquery", function (t) {
    ...
    var e = cifor.$, i = {
        fixbar: function (t) {
            var i, a, n = "cifor-fixbar", r = "cifor-fixbar-top", o = e(document), l = e("body");
            t = e.extend({showHeight: 200}, t), t.bar1 = t.bar1 === !0 ? "&#xe606;" : t.bar1, t.bar2 = t.bar2 === !0 ? "&#xe607;" : t.bar2, t.bgcolor = t.bgcolor ? "background-color:" + t.bgcolor : "";
            var c = [t.bar1, t.bar2, "&#xe604;"],
                g = e(['<ul class="' + n + '">', t.bar1 ? '<li class="cifor-icon" lay-type="bar1" style="' + t.bgcolor + '">' + c[0] + "</li>" : "", t.bar2 ? '<li class="cifor-icon" lay-type="bar2" style="' + t.bgcolor + '">' + c[1] + "</li>" : "", '<li class="cifor-icon ' + r + '" lay-type="top" style="' + t.bgcolor + '">' + c[2] + "</li>", "</ul>"].join("")),
...
cifor.define("jquery", function (e) {
    "use strict";
    var l = cifor.$, o = function (e) {
    }, t = '<i class="cifor-anim cifor-anim-rotate cifor-anim-loop cifor-icon ">&#xe63e;</i>';
    o.prototype.load = function (e) {
        ...
        if (f[0]) {
            var m = l(e.scrollElem || document), u = e.mb || 50, s = !("isAuto" in e) || e.isAuto, v = e.end || "没有更多了",
                ...
                h = l('<div class="cifor-flow-more"><a href="javascript:;">' + d + "</a></div>");
            f.find(".cifor-flow-more")[0] || f.append(h);
            var p = function (e, t) {
...
cifor.define(["layer", "form"], function (t) {
    "use strict";
    var e = cifor.$, i = cifor.layer, a = cifor.form, l = (cifor.hint(), cifor.device()), n = "layedit",
        o = "cifor-show", r = "cifor-disabled", c = function () {
            var t = this;
            t.index = 0, t.config = {
    ...
    c.prototype.set = function (t) {
        ...
        return cifor.onevent(n, t, e)
    }, c.prototype.build = function (t, i) {
        i = i || {};
        var a = this, n = a.config, r = "cifor-layedit", c = e("string" == typeof t ? "#" + t : t),
            u = "LAY_layedit_" + ++a.index, d = c.next("." + r), y = e.extend({}, n, i), f = function () {
                var t = [], e = {};
                return cifor.each(y.hideTool, function (t, i) {
                    e[i] = !0
                }), cifor.each(y.tool, function (i, a) {
                    C[a] && !e[a] && t.push(C[a])
                }), t.join("")
            }(),
            m = e(['<div class="' + r + '">', '<div class="cifor-unselect cifor-layedit-tool">' + f + "</div>", '<div class="cifor-layedit-iframe">', '<iframe id="' + u + '" name="' + u + '" textarea="' + t + '" frameborder="0"></iframe>', "</div>", "</div>"].join(""));
        return l.ie && l.ie < 8 ? c.removeClass("cifor-hide").addClass(o) : (d[0] && d.remove(), s.call(a, m, c[0], y), c.addClass("cifor-hide").after(m), a.index)
    ...
    var s = function (t, i, a) {
        ...
        }), t.find("table").addClass("cifor-table"), t.find("script,link").remove()
    }, m = function (t) {
        ...
        var n = t.document, o = e(n.body), c = {
            link: function (i) {
                ...
                i.open({
                    ...
                    shadeClose: !0,
                    shade: .1,
                    skin: "cifor-layer-msg",
                    content: ["http://www.cifor.com/about/layedit/help.html", "no"]
                })
            }
        }, s = a.find(".cifor-layedit-tool"), u = function () {
        ...
        var l = this, n = i.open({
            ...
            title: "超链接",
            skin: "cifor-layer-msg",
            content: ['<ul class="cifor-form" style="margin: 15px;">', '<li class="cifor-form-item">', '<label class="cifor-form-label" style="width: 60px;">URL</label>', '<div class="cifor-input-block" style="margin-left: 90px">', '<input name="url" lay-verify="url" value="' + (t.href || "") + '" autofocus="true" autocomplete="off" class="cifor-input">', "</div>", "</li>", '<li class="cifor-form-item">', '<label class="cifor-form-label" style="width: 60px;">打开方式</label>', '<div class="cifor-input-block" style="margin-left: 90px">', '<input type="radio" name="target" value="_self" class="cifor-input" title="当前窗口"' + ("_self" !== t.target && t.target ? "" : "checked") + ">", '<input type="radio" name="target" value="_blank" class="cifor-input" title="新窗口" ' + ("_blank" === t.target ? "checked" : "") + ">", "</div>", "</li>", '<li class="cifor-form-item" style="text-align: center;">', '<button type="button" lay-submit lay-filter="layedit-link-yes" class="cifor-btn"> 确定 </button>', '<button style="margin-left: 20px;" type="button" class="cifor-btn cifor-btn-primary"> 取消 </button>', "</li>", "</ul>"].join(""),
            success: function (t, n) {
                var o = "submit(layedit-link-yes)";
                a.render("radio"), t.find(".cifor-btn-primary").on("click", function () {
                    i.close(n), l.focus()
                }), a.on(o, function (t) {
        ...
        var a = function () {
            var t = ["[微笑]", "[嘻嘻]", "[哈哈]", "[可爱]", "[可怜]", "[挖鼻]", "[吃惊]", "[害羞]", "[挤眼]", "[闭嘴]", "[鄙视]", "[爱你]", "[泪]", "[偷笑]", "[亲亲]", "[生病]", "[太开心]", "[白眼]", "[右哼哼]", "[左哼哼]", "[嘘]", "[衰]", "[委屈]", "[吐]", "[哈欠]", "[抱抱]", "[怒]", "[疑问]", "[馋嘴]", "[拜拜]", "[思考]", "[汗]", "[困]", "[睡]", "[钱]", "[失望]", "[酷]", "[色]", "[哼]", "[鼓掌]", "[晕]", "[悲伤]", "[抓狂]", "[黑线]", "[阴险]", "[怒骂]", "[互粉]", "[心]", "[伤心]", "[猪头]", "[熊猫]", "[兔子]", "[ok]", "[耶]", "[good]", "[NO]", "[赞]", "[来]", "[弱]", "[草泥马]", "[神马]", "[囧]", "[浮云]", "[给力]", "[围观]", "[威武]", "[奥特曼]", "[礼物]", "[钟]", "[话筒]", "[蜡烛]", "[蛋糕]"],
                e = {};
            return cifor.each(t, function (t, i) {
                e[i] = cifor.cache.dir + "images/face/" + t + ".gif"
            }), e
        }();
        return x.hide = x.hide || function (t) {
            ...
            var t = [];
            return cifor.each(a, function (e, i) {
                t.push('<li title="' + e + '"><img src="' + i + '" alt="' + e + '"></li>')
            }), '<ul class="cifor-clear">' + t.join("") + "</ul>"
        }(), this, {
            tips: 1, time: 0, skin: "cifor-box cifor-util-face", maxWidth: 500, success: function (l, n) {
                l.css({marginTop: -4, marginLeft: -10}).find(".cifor-clear>li").on("click", function () {
        ...
        var e = this, l = i.open({
            ...
            title: "插入代码",
            skin: "cifor-layer-msg",
            content: ['<ul class="cifor-form cifor-form-pane" style="margin: 15px;">', '<li class="cifor-form-item">', '<label class="cifor-form-label">请选择语言</label>', '<div class="cifor-input-block">', '<select name="lang">', '<option value="JavaScript">JavaScript</option>', '<option value="HTML">HTML</option>', '<option value="CSS">CSS</option>', '<option value="Java">Java</option>', '<option value="PHP">PHP</option>', '<option value="C#">C#</option>', '<option value="Python">Python</option>', '<option value="Ruby">Ruby</option>', '<option value="Go">Go</option>', "</select>", "</div>", "</li>", '<li class="cifor-form-item cifor-form-text">', '<label class="cifor-form-label">代码</label>', '<div class="cifor-input-block">', '<textarea name="code" lay-verify="required" autofocus="true" class="cifor-textarea" style="height: 200px;"></textarea>', "</div>", "</li>", '<li class="cifor-form-item" style="text-align: center;">', '<button type="button" lay-submit lay-filter="layedit-code-yes" class="cifor-btn"> 确定 </button>', '<button style="margin-left: 20px;" type="button" class="cifor-btn cifor-btn-primary"> 取消 </button>', "</li>", "</ul>"].join(""),
            success: function (l, n) {
                var o = "submit(layedit-code-yes)";
                a.render("select"), l.find(".cifor-btn-primary").on("click", function () {
                    i.close(n), e.focus()
                }), a.on(o, function (e) {
        ...
        html: '<i class="cifor-icon layedit-tool-html" title="HTML源代码" lay-command="html" layedit-event="html"">&#xe64b;</i><span class="layedit-tool-mid"></span>',
        strong: '<i class="cifor-icon layedit-tool-b" title="加粗" lay-command="Bold" layedit-event="b"">&#xe62b;</i>',
        italic: '<i class="cifor-icon layedit-tool-i" title="斜体" lay-command="italic" layedit-event="i"">&#xe644;</i>',
        underline: '<i class="cifor-icon layedit-tool-u" title="下划线" lay-command="underline" layedit-event="u"">&#xe646;</i>',
        del: '<i class="cifor-icon layedit-tool-d" title="删除线" lay-command="strikeThrough" layedit-event="d"">&#xe64f;</i>',
        "|": '<span class="layedit-tool-mid"></span>',
        left: '<i class="cifor-icon layedit-tool-left" title="左对齐" lay-command="justifyLeft" layedit-event="left"">&#xe649;</i>',
        center: '<i class="cifor-icon layedit-tool-center" title="居中对齐" lay-command="justifyCenter" layedit-event="center"">&#xe647;</i>',
        right: '<i class="cifor-icon layedit-tool-right" title="右对齐" lay-command="justifyRight" layedit-event="right"">&#xe648;</i>',
        link: '<i class="cifor-icon layedit-tool-link" title="插入链接" layedit-event="link"">&#xe64c;</i>',
        unlink: '<i class="cifor-icon layedit-tool-unlink cifor-disabled" title="清除链接" lay-command="unlink" layedit-event="unlink"">&#xe64d;</i>',
        face: '<i class="cifor-icon layedit-tool-face" title="表情" layedit-event="face"">&#xe650;</i>',
        image: '<i class="cifor-icon layedit-tool-image" title="图片" layedit-event="image">&#xe64a;<input type="file" name="file"></i>',
        code: '<i class="cifor-icon layedit-tool-code" title="插入代码" layedit-event="code">&#xe64e;</i>',
        help: '<i class="cifor-icon layedit-tool-help" title="帮助" layedit-event="help">&#xe607;</i>'
    }, w = new c;
    t(n, w)
});
cifor.define("jquery", function (e) {
    "use strict";
    var a = cifor.$, l = "http://www.cifor.com/doc/modules/code.html";
    e("code", function (e) {
        var t = [];
        e = e || {}, e.elem = a(e.elem || ".cifor-code"), e.about = !("about" in e) || e.about, e.elem.each(function () {
            t.push(this)
        }), cifor.each(t.reverse(), function (t, i) {
            var c = a(i), o = c.html();
            (c.attr("lay-encode") || e.encode) && (o = o.replace(/&(?!#?[a-zA-Z0-9]+;)/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/'/g, "&#39;").replace(/"/g, "&quot;")), c.html('<ol class="cifor-code-ol"><li>' + o.replace(/[\r\t\n]+/g, "</li><li>") + "</li></ol>"), c.find(">.cifor-code-h3")[0] || c.prepend('<h3 class="cifor-code-h3">' + (c.attr("lay-title") || e.title || "code") + (e.about ? '<a href="' + l + '" target="_blank">cifor.code</a>' : "") + "</h3>");
            var d = c.find(">.cifor-code-ol");
            c.addClass("cifor-box cifor-code-view"), (c.attr("lay-skin") || e.skin) && c.addClass("cifor-code-" + (c.attr("lay-skin") || e.skin)), (d.find("li").length / 100 | 0) > 0 && d.css("margin-left", (d.find("li").length / 100 | 0) + "px"), (c.attr("lay-height") || e.height) && d.css("max-height", c.attr("lay-height") || e.height)
        })
    })
